...
export function svgCompresor(on) {
  ...
  return `
    <svg class="eq-svg eq-compresor${cls}" viewBox="0 0 32 32" aria-hidden="true">
      <!-- base -->
      <rect x="3"  y="22" width="26" height="6" rx="1.5" fill="#4B5563" stroke="#2E80D8" stroke-width="0.6"/>
      <!-- cilindros -->
      <rect class="eq-cyl" x="7"  y="6"  width="6" height="16" rx="1" fill="#374151" stroke="#2E80D8" stroke-width="0.6"/>
      <rect class="eq-cyl" x="19" y="6"  width="6" height="16" rx="1" fill="#374151" stroke="#2E80D8" stroke-width="0.6"/>
      <!-- pistones (animados) -->
      ...
      <!-- tubería superior -->
      <rect x="8" y="3" width="16" height="3" rx="1" fill="#2D3748" stroke="#2E80D8" stroke-width="0.6"/>
      <!-- piloto ON -->
...
function svgCondensador(on) {
  ...
  return `
    <svg class="eq-svg eq-condensador${cls}" viewBox="0 0 32 32" aria-hidden="true">
      <!-- carcasa -->
      <rect x="2" y="4" width="28" height="24" rx="2" fill="#374151" stroke="#2E80D8" stroke-width="0.6"/>
      <!-- rejilla -->
      <line x1="5" y1="8"  x2="27" y2="8"  stroke="#4B5563" stroke-width="0.4"/>
      <line x1="5" y1="11" x2="27" y2="11" stroke="#4B5563" stroke-width="0.4"/>
      <line x1="5" y1="22" x2="27" y2="22" stroke="#4B5563" stroke-width="0.4"/>
      <line x1="5" y1="25" x2="27" y2="25" stroke="#4B5563" stroke-width="0.4"/>
      <!-- ventilador -->
      <circle cx="16" cy="16" r="6" fill="#2D3748" stroke="#2E80D8" stroke-width="0.6"/>
      <g class="eq-fan">
        ...
        <circle cx="16" cy="16" r="1.4" fill="#1F2937" stroke="#2E80D8" stroke-width="0.5"/>
      </g>
    </svg>
  `;
}
...
function svgBomba(on) {
  ...
  return `
    <svg class="eq-svg eq-bomba${cls}" viewBox="0 0 32 32" aria-hidden="true">
      <!-- carcasa redonda -->
      <circle cx="16" cy="16" r="11" fill="#374151" stroke="#2E80D8" stroke-width="0.6"/>
      <!-- tubería entrada -->
      <rect x="0" y="14" width="6" height="4" fill="#2D3748" stroke="#2E80D8" stroke-width="0.4"/>
      <!-- tubería salida superior -->
      <rect x="14" y="0" width="4" height="6" fill="#2D3748" stroke="#2E80D8" stroke-width="0.4"/>
      <!-- impulsor giratorio -->
      <g class="eq-impeller">
        ...
        <circle cx="16" cy="16" r="1.2" fill="#1F2937" stroke="#2E80D8" stroke-width="0.4"/>
      </g>
    </svg>
  `;
}
...
export function svgEvaporador(on) {
  ...
  return `
    <svg class="eq-svg eq-evaporador${cls}" viewBox="0 0 32 32" aria-hidden="true">
      <!-- carcasa -->
      <rect x="2" y="6" width="28" height="20" rx="2" fill="#374151" stroke="#2E80D8" stroke-width="0.6"/>
      ...
      <circle cx="25" cy="16" r="3.6" fill="#2D3748" stroke="#2E80D8" stroke-width="0.5"/>
      <g class="eq-fan-right">
        ...
        <circle cx="25" cy="16" r="0.9" fill="#1F2937" stroke="#2E80D8" stroke-width="0.3"/>
      </g>
      <!-- bandeja de drenaje -->
      <rect x="3" y="25" width="26" height="2" rx="0.5" fill="#4B5563" stroke="#2E80D8" stroke-width="0.4"/>
    </svg>
  `;
}
